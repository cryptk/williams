export default function Button({
  ...
  const variantMap = {
    ...
    secondary:
      "bg-secondary-light border-2 border-secondary hover:bg-secondary text-gray",
    secondaryHollow:
  ...
  return (
    <>
      <button
        type="button"
        class={`${variantClasses} px-4 py-2 text-base drop-shadow-md drop-shadow-secondary hover:drop-shadow-lg hover:drop-shadow-secondary rounded-md font-semibold inline-block transition-all hover:scale-103 ${extraClasses}`}
        {...props}
      >
        {children}
      </button>
