...
export function Categories() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      console.error('Failed to delete category:', error) // eslint-disable-line no-console -- We only allow console logging for debugging purposes
      toast.error('Failed to delete category. It may be in use by existing bills.')
    } finally {
      setDeleting(false)
    }
  }
